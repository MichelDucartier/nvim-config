return {
    ...
    keys = {
        { "<leader>S",  function() require("spectre").toggle() end,                                 desc = "Toggle Spectre",         mode = "n" },
        ...
        { "<leader>sp", function() require("spectre").open_file_search({ select_word = true }) end, desc = "Search on current file", mode = "n" },
    }
}
